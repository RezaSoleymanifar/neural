...
The standalone design enables users with granular control over dataset creation, feature engineering, model architecture, market simulation, reward shaping and low level control over training in a clean and pythonic fashion. This allows shift focus from initial setup to more rapid prottyping, and model discovery.