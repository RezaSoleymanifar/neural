...
class DataSchema:
    ...
    def __add__(self, other: DataSchema) -> DataSchema:
        ...
        other_schema = other.data_type_assets_map
        for data_type in other_schema:
            if data_type in schema:
                ...
                schema[data_type] = other_schema[data_type]
...
class StaticDataFeeder(AbstractDataFeeder):
    ...
    def get_features_generator(self) -> Iterable[np.ndarray]:
        """
        This method returns a generator object that can be used for
        iterative provision of data for market simulation. Data is
        loaded in chunks and each chunk is loaded into memory and then
